...
test.describe('Splitting an expense across a group', () => {
  ...
  test('An uneven split where not everyone shared the expense', async ({ Given, When, Then, And, addExpense, group, home }) => { 
    await Given('a group named "Kyoto trip" with members:', {"dataTable":{"rows":[{"cells":[{"value":"name"}]},{"cells":[{"value":"Yuto"}]},{"cells":[{"value":"Aoi"}]},{"cells":[{"value":"Ren"}]},{"cells":[{"value":"Sana"}]}]}}, { group, home }); 
    await When('Yuto adds an expense of ¥5000 for "dinner", with Sana not sharing, split exactly:', {"dataTable":{"rows":[{"cells":[{"value":"member"},{"value":"amount"}]},{"cells":[{"value":"Yuto"},{"value":"2000"}]},{"cells":[{"value":"Aoi"},{"value":"2000"}]},{"cells":[{"value":"Ren"},{"value":"1000"}]}]}}, { addExpense, group }); 
    await Then('the balances are:', {"dataTable":{"rows":[{"cells":[{"value":"member"},{"value":"balance"}]},{"cells":[{"value":"Yuto"},{"value":"+¥3,000"}]},{"cells":[{"value":"Aoi"},{"value":"−¥2,000"}]},{"cells":[{"value":"Ren"},{"value":"−¥1,000"}]},{"cells":[{"value":"Sana"},{"value":"¥0"}]}]}}, { group }); 
    await And('the history shows "dinner" paid by Yuto', null, { group }); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":13,"pickleLine":29,"tags":[],"steps":[{"pwStepLine":14,"gherkinStepLine":30,"keywordType":"Context","textWithKeyword":"Given a group named \"Kyoto trip\" with members:","stepMatchArguments":[{"group":{"start":14,"value":"\"Kyoto trip\"","children":[{"start":15,"value":"Kyoto trip","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]},{"pwStepLine":15,"gherkinStepLine":36,"keywordType":"Action","textWithKeyword":"When Yuto adds an expense of ¥5000 for \"dinner\", with Sana not sharing, split exactly:","stepMatchArguments":[{"group":{"start":0,"value":"Yuto"},"parameterTypeName":"word"},{"group":{"start":25,"value":"5000"},"parameterTypeName":"int"},{"group":{"start":34,"value":"\"dinner\"","children":[{"start":35,"value":"dinner","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"},{"group":{"start":49,"value":"Sana"},"parameterTypeName":"word"}]},{"pwStepLine":16,"gherkinStepLine":45,"keywordType":"Outcome","textWithKeyword":"Then the balances are:","stepMatchArguments":[]},{"pwStepLine":17,"gherkinStepLine":51,"keywordType":"Outcome","textWithKeyword":"And the history shows \"dinner\" paid by Yuto","stepMatchArguments":[{"group":{"start":18,"value":"\"dinner\"","children":[{"start":19,"value":"dinner","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"},{"group":{"start":35,"value":"Yuto"},"parameterTypeName":"word"}]}]},
]; // bdd-data-end