...
test.describe('Settling up on the proposed plan', () => {
  ...
  test('A transfer marked paid on one phone disappears from another\'s open plan', async ({ Given, When, Then, And, addExpense, group, home, secondPhone, settle }) => { 
    await Given('a group named "Kyoto trip" with members:', {"dataTable":{"rows":[{"cells":[{"value":"name"}]},{"cells":[{"value":"Yuto"}]},{"cells":[{"value":"Aoi"}]}]}}, { group, home }); 
    await When('a second phone opens the invite link', null, { group, secondPhone }); 
    await And('picks Aoi', null, { secondPhone }); 
    await And('Yuto adds an expense of ¥2000 for "dinner" split equally', null, { addExpense, group }); 
    await And('someone views the settle plan', null, { group }); 
    await Then('the settle plan proposes:', {"dataTable":{"rows":[{"cells":[{"value":"from"},{"value":"to"},{"value":"amount"}]},{"cells":[{"value":"Aoi"},{"value":"Yuto"},{"value":"¥1,000"}]}]}}, { settle }); 
    await When('the second phone views the settle plan', null, { secondPhone }); 
    await And('the second phone marks Aoi pays Yuto ¥1000', null, { secondPhone }); 
    await Then('the settle plan no longer proposes Aoi pays Yuto', null, { settle }); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":29,"pickleLine":70,"tags":[],"steps":[{"pwStepLine":30,"gherkinStepLine":71,"keywordType":"Context","textWithKeyword":"Given a group named \"Kyoto trip\" with members:","stepMatchArguments":[{"group":{"start":14,"value":"\"Kyoto trip\"","children":[{"start":15,"value":"Kyoto trip","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]},{"pwStepLine":31,"gherkinStepLine":81,"keywordType":"Action","textWithKeyword":"When a second phone opens the invite link","stepMatchArguments":[]},{"pwStepLine":32,"gherkinStepLine":82,"keywordType":"Action","textWithKeyword":"And picks Aoi","stepMatchArguments":[{"group":{"start":6,"value":"Aoi"},"parameterTypeName":"word"}]},{"pwStepLine":33,"gherkinStepLine":83,"keywordType":"Action","textWithKeyword":"And Yuto adds an expense of ¥2000 for \"dinner\" split equally","stepMatchArguments":[{"group":{"start":0,"value":"Yuto"},"parameterTypeName":"word"},{"group":{"start":25,"value":"2000"},"parameterTypeName":"int"},{"group":{"start":34,"value":"\"dinner\"","children":[{"start":35,"value":"dinner","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]},{"pwStepLine":34,"gherkinStepLine":84,"keywordType":"Action","textWithKeyword":"And someone views the settle plan","stepMatchArguments":[]},{"pwStepLine":35,"gherkinStepLine":85,"keywordType":"Outcome","textWithKeyword":"Then the settle plan proposes:","stepMatchArguments":[]},{"pwStepLine":36,"gherkinStepLine":88,"keywordType":"Action","textWithKeyword":"When the second phone views the settle plan","stepMatchArguments":[]},{"pwStepLine":37,"gherkinStepLine":89,"keywordType":"Action","textWithKeyword":"And the second phone marks Aoi pays Yuto ¥1000","stepMatchArguments":[{"group":{"start":23,"value":"Aoi"},"parameterTypeName":"word"},{"group":{"start":32,"value":"Yuto"},"parameterTypeName":"word"},{"group":{"start":38,"value":"1000"},"parameterTypeName":"int"}]},{"pwStepLine":38,"gherkinStepLine":96,"keywordType":"Outcome","textWithKeyword":"Then the settle plan no longer proposes Aoi pays Yuto","stepMatchArguments":[{"group":{"start":35,"value":"Aoi"},"parameterTypeName":"word"},{"group":{"start":44,"value":"Yuto"},"parameterTypeName":"word"}]}]},
]; // bdd-data-end